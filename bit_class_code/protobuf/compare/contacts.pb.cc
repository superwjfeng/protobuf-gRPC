...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::Address, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::Address, _impl_.home_address_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::Address, _impl_.unit_address_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo_Phone, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo_Phone, _impl_.number_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo_Phone, _impl_.type_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse, key_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse, value_),
  0,
  1,
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _impl_._oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _impl_.age_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _impl_.phone_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _impl_.data_),
  ::_pbi::kInvalidFieldOffsetTag,
  ::_pbi::kInvalidFieldOffsetTag,
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _impl_.remark_),
  PROTOBUF_FIELD_OFFSET(::compare_serialization::PeopleInfo, _impl_.other_contact_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::compare_serialization::Address)},
  { 8, -1, -1, sizeof(::compare_serialization::PeopleInfo_Phone)},
  { 16, 24, -1, sizeof(::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse)},
  { 26, -1, -1, sizeof(::compare_serialization::PeopleInfo)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::compare_serialization::_Address_default_instance_._instance,
  &::compare_serialization::_PeopleInfo_Phone_default_instance_._instance,
  &::compare_serialization::_PeopleInfo_RemarkEntry_DoNotUse_default_instance_._instance,
  &::compare_serialization::_PeopleInfo_default_instance_._instance,
};

const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016contacts.proto\022\025compare_serialization\032"
  "\031google/protobuf/any.proto\"5\n\007Address\022\024\n"
  "\014home_address\030\001 \001(\t\022\024\n\014unit_address\030\002 \001("
  "\t\"\232\003\n\nPeopleInfo\022\014\n\004name\030\001 \001(\t\022\013\n\003age\030\002 "
  "\001(\005\0226\n\005phone\030\003 \003(\0132\'.compare_serializati"
  "on.PeopleInfo.Phone\022\"\n\004data\030\004 \001(\0132\024.goog"
  "le.protobuf.Any\022\014\n\002qq\030\005 \001(\tH\000\022\020\n\006weixin\030"
  "\006 \001(\tH\000\022=\n\006remark\030\007 \003(\0132-.compare_serial"
  "ization.PeopleInfo.RemarkEntry\032v\n\005Phone\022"
  "\016\n\006number\030\001 \001(\t\022\?\n\004type\030\002 \001(\01621.compare_"
  "serialization.PeopleInfo.Phone.PhoneType"
  "\"\034\n\tPhoneType\022\006\n\002MP\020\000\022\007\n\003TEL\020\001\032-\n\013Remark"
  "Entry\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\t:\0028\001B\017\n"
  "\rother_contactb\006proto3"
  ;
...
Address::Address(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:compare_serialization.Address)
}
Address::Address(const Address& from)
  ...
  // @@protoc_insertion_point(copy_constructor:compare_serialization.Address)
}
...
Address::~Address() {
  // @@protoc_insertion_point(destructor:compare_serialization.Address)
...
void Address::Clear() {
// @@protoc_insertion_point(message_clear_start:compare_serialization.Address)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "compare_serialization.Address.home_address"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "compare_serialization.Address.unit_address"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Address::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:compare_serialization.Address)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_home_address().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "compare_serialization.Address.home_address");
  ...
  if (!this->_internal_unit_address().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "compare_serialization.Address.unit_address");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:compare_serialization.Address)
  return target;
}

size_t Address::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:compare_serialization.Address)
  size_t total_size = 0;
...
void Address::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:compare_serialization.Address)
...
// @@protoc_insertion_point(class_specific_copy_from_start:compare_serialization.Address)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PeopleInfo_Phone::PeopleInfo_Phone(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:compare_serialization.PeopleInfo.Phone)
}
PeopleInfo_Phone::PeopleInfo_Phone(const PeopleInfo_Phone& from)
  ...
  // @@protoc_insertion_point(copy_constructor:compare_serialization.PeopleInfo.Phone)
}
...
PeopleInfo_Phone::~PeopleInfo_Phone() {
  // @@protoc_insertion_point(destructor:compare_serialization.PeopleInfo.Phone)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:compare_serialization.PeopleInfo.Phone)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "compare_serialization.PeopleInfo.Phone.number"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_type(static_cast<::compare_serialization::PeopleInfo_Phone_PhoneType>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* PeopleInfo_Phone::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:compare_serialization.PeopleInfo.Phone)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_number().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "compare_serialization.PeopleInfo.Phone.number");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:compare_serialization.PeopleInfo.Phone)
  return target;
}

size_t PeopleInfo_Phone::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:compare_serialization.PeopleInfo.Phone)
  size_t total_size = 0;
...
void PeopleInfo_Phone::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:compare_serialization.PeopleInfo.Phone)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:compare_serialization.PeopleInfo.Phone)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PeopleInfo::PeopleInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:compare_serialization.PeopleInfo)
}
PeopleInfo::PeopleInfo(const PeopleInfo& from)
  ...
  // @@protoc_insertion_point(copy_constructor:compare_serialization.PeopleInfo)
}
...
PeopleInfo::~PeopleInfo() {
  // @@protoc_insertion_point(destructor:compare_serialization.PeopleInfo)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    ArenaDtor(this);
    return;
...
// @@protoc_insertion_point(one_of_clear_start:compare_serialization.PeopleInfo)
...
// @@protoc_insertion_point(message_clear_start:compare_serialization.PeopleInfo)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "compare_serialization.PeopleInfo.name"));
        } else
          goto handle_unusual;
        continue;
      // int32 age = 2;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "compare_serialization.PeopleInfo.qq"));
        } else
          goto handle_unusual;
        continue;
      // string weixin = 6;
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "compare_serialization.PeopleInfo.weixin"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* PeopleInfo::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:compare_serialization.PeopleInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "compare_serialization.PeopleInfo.name");
    target = stream->WriteStringMaybeAliased(
  ...
  if (_internal_has_qq()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "compare_serialization.PeopleInfo.qq");
    target = stream->WriteStringMaybeAliased(
  ...
  if (_internal_has_weixin()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "compare_serialization.PeopleInfo.weixin");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_remark().empty()) {
    ...
    auto check_utf8 = [](const MapType::value_type& entry) {
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        ...
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "compare_serialization.PeopleInfo.RemarkEntry.key");
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        entry.second.data(), static_cast<int>(entry.second.length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "compare_serialization.PeopleInfo.RemarkEntry.value");
    };
  ...
  // @@protoc_insertion_point(serialize_to_array_end:compare_serialization.PeopleInfo)
  return target;
}

size_t PeopleInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:compare_serialization.PeopleInfo)
  size_t total_size = 0;
...
void PeopleInfo::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:compare_serialization.PeopleInfo)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:compare_serialization.PeopleInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::compare_serialization::Address*
Arena::CreateMaybeMessage< ::compare_serialization::Address >(Arena* arena) {
  return Arena::CreateMessageInternal< ::compare_serialization::Address >(arena);
}
template<> PROTOBUF_NOINLINE ::compare_serialization::PeopleInfo_Phone*
Arena::CreateMaybeMessage< ::compare_serialization::PeopleInfo_Phone >(Arena* arena) {
  return Arena::CreateMessageInternal< ::compare_serialization::PeopleInfo_Phone >(arena);
}
template<> PROTOBUF_NOINLINE ::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse*
Arena::CreateMaybeMessage< ::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::compare_serialization::PeopleInfo_RemarkEntry_DoNotUse >(arena);
}
template<> PROTOBUF_NOINLINE ::compare_serialization::PeopleInfo*
Arena::CreateMaybeMessage< ::compare_serialization::PeopleInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::compare_serialization::PeopleInfo >(arena);
}
