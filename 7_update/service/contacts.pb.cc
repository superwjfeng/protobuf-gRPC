...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::s_contacts::PeopleInfo, _impl_.age_),
...
const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  " \003(\0132\034.s_contacts.PeopleInfo.Phone\032\027\n\005Ph"
  "one\022\016\n\006number\030\001 \001(\t\"4\n\010Contacts\022(\n\010conta"
  "cts\030\001 \003(\0132\026.s_contacts.PeopleInfob\006proto"
  "3"
  ;
