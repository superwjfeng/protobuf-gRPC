...
PROTOBUF_NAMESPACE_OPEN
template<> ::c_contacts::Contacts* Arena::CreateMaybeMessage<::c_contacts::Contacts>(Arena*);
template<> ::c_contacts::PeopleInfo* Arena::CreateMaybeMessage<::c_contacts::PeopleInfo>(Arena*);
template<> ::c_contacts::PeopleInfo_Phone* Arena::CreateMaybeMessage<::c_contacts::PeopleInfo_Phone>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace c_contacts {
...
class PeopleInfo_Phone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:c_contacts.PeopleInfo.Phone) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "c_contacts.PeopleInfo.Phone";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:c_contacts.PeopleInfo.Phone)
 private:
  class _Internal;
...
class PeopleInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:c_contacts.PeopleInfo) */ {
 public:
  ...
  // repeated .c_contacts.PeopleInfo.Phone phone = 3;
  int phone_size() const;
  private:
  int _internal_phone_size() const;
  public:
  void clear_phone();
  ::c_contacts::PeopleInfo_Phone* mutable_phone(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo_Phone >*
      mutable_phone();
  private:
  const ::c_contacts::PeopleInfo_Phone& _internal_phone(int index) const;
  ::c_contacts::PeopleInfo_Phone* _internal_add_phone();
  public:
  const ::c_contacts::PeopleInfo_Phone& phone(int index) const;
  ::c_contacts::PeopleInfo_Phone* add_phone();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo_Phone >&
      phone() const;
  ...
  // @@protoc_insertion_point(class_scope:c_contacts.PeopleInfo)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo_Phone > phone_;
...
class Contacts final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:c_contacts.Contacts) */ {
 public:
  ...
  // repeated .c_contacts.PeopleInfo contacts = 1;
  int contacts_size() const;
  private:
  int _internal_contacts_size() const;
  public:
  void clear_contacts();
  ::c_contacts::PeopleInfo* mutable_contacts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo >*
      mutable_contacts();
  private:
  const ::c_contacts::PeopleInfo& _internal_contacts(int index) const;
  ::c_contacts::PeopleInfo* _internal_add_contacts();
  public:
  const ::c_contacts::PeopleInfo& contacts(int index) const;
  ::c_contacts::PeopleInfo* add_contacts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo >&
      contacts() const;

  // @@protoc_insertion_point(class_scope:c_contacts.Contacts)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo > contacts_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_contacts_2eproto;
...
inline const std::string& PeopleInfo_Phone::number() const {
  // @@protoc_insertion_point(field_get:c_contacts.PeopleInfo.Phone.number)
...
void PeopleInfo_Phone::set_number(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:c_contacts.PeopleInfo.Phone.number)
}
inline std::string* PeopleInfo_Phone::mutable_number() {
  std::string* _s = _internal_mutable_number();
  // @@protoc_insertion_point(field_mutable:c_contacts.PeopleInfo.Phone.number)
  return _s;
}
...
inline std::string* PeopleInfo_Phone::release_number() {
  // @@protoc_insertion_point(field_release:c_contacts.PeopleInfo.Phone.number)
...
inline void PeopleInfo_Phone::set_allocated_number(std::string* number) {
  ...
  // @@protoc_insertion_point(field_set_allocated:c_contacts.PeopleInfo.Phone.number)
}
...
inline const std::string& PeopleInfo::name() const {
  // @@protoc_insertion_point(field_get:c_contacts.PeopleInfo.name)
...
void PeopleInfo::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:c_contacts.PeopleInfo.name)
}
inline std::string* PeopleInfo::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:c_contacts.PeopleInfo.name)
  return _s;
}
...
inline std::string* PeopleInfo::release_name() {
  // @@protoc_insertion_point(field_release:c_contacts.PeopleInfo.name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:c_contacts.PeopleInfo.name)
}
...
inline int32_t PeopleInfo::age() const {
  // @@protoc_insertion_point(field_get:c_contacts.PeopleInfo.age)
...
inline void PeopleInfo::set_age(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:c_contacts.PeopleInfo.age)
}
...
inline ::c_contacts::PeopleInfo_Phone* PeopleInfo::mutable_phone(int index) {
  // @@protoc_insertion_point(field_mutable:c_contacts.PeopleInfo.phone)
  return _impl_.phone_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo_Phone >*
PeopleInfo::mutable_phone() {
  // @@protoc_insertion_point(field_mutable_list:c_contacts.PeopleInfo.phone)
  return &_impl_.phone_;
}
inline const ::c_contacts::PeopleInfo_Phone& PeopleInfo::_internal_phone(int index) const {
  return _impl_.phone_.Get(index);
}
inline const ::c_contacts::PeopleInfo_Phone& PeopleInfo::phone(int index) const {
  // @@protoc_insertion_point(field_get:c_contacts.PeopleInfo.phone)
  return _internal_phone(index);
}
inline ::c_contacts::PeopleInfo_Phone* PeopleInfo::_internal_add_phone() {
  return _impl_.phone_.Add();
}
inline ::c_contacts::PeopleInfo_Phone* PeopleInfo::add_phone() {
  ::c_contacts::PeopleInfo_Phone* _add = _internal_add_phone();
  // @@protoc_insertion_point(field_add:c_contacts.PeopleInfo.phone)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo_Phone >&
PeopleInfo::phone() const {
  // @@protoc_insertion_point(field_list:c_contacts.PeopleInfo.phone)
  return _impl_.phone_;
}
...
inline ::c_contacts::PeopleInfo* Contacts::mutable_contacts(int index) {
  // @@protoc_insertion_point(field_mutable:c_contacts.Contacts.contacts)
  return _impl_.contacts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo >*
Contacts::mutable_contacts() {
  // @@protoc_insertion_point(field_mutable_list:c_contacts.Contacts.contacts)
  return &_impl_.contacts_;
}
inline const ::c_contacts::PeopleInfo& Contacts::_internal_contacts(int index) const {
  return _impl_.contacts_.Get(index);
}
inline const ::c_contacts::PeopleInfo& Contacts::contacts(int index) const {
  // @@protoc_insertion_point(field_get:c_contacts.Contacts.contacts)
  return _internal_contacts(index);
}
inline ::c_contacts::PeopleInfo* Contacts::_internal_add_contacts() {
  return _impl_.contacts_.Add();
}
inline ::c_contacts::PeopleInfo* Contacts::add_contacts() {
  ::c_contacts::PeopleInfo* _add = _internal_add_contacts();
  // @@protoc_insertion_point(field_add:c_contacts.Contacts.contacts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_contacts::PeopleInfo >&
Contacts::contacts() const {
  // @@protoc_insertion_point(field_list:c_contacts.Contacts.contacts)
  return _impl_.contacts_;
}
