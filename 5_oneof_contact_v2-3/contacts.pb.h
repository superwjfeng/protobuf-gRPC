...
inline const std::string& Address::work_address() const {
  // @@protoc_insertion_point(field_get:contacts2.Address.work_address)
...
void Address::set_work_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.work_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts2.Address.work_address)
}
inline std::string* Address::mutable_work_address() {
  std::string* _s = _internal_mutable_work_address();
  // @@protoc_insertion_point(field_mutable:contacts2.Address.work_address)
  return _s;
}
...
inline std::string* Address::release_work_address() {
  // @@protoc_insertion_point(field_release:contacts2.Address.work_address)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contacts2.Address.work_address)
}
